...
### Gráfica de LÍNEAS del número semanal de casos de dengue, 2013-2019 hasta la semana epidemiológica 41 ----
...
bd %>% 
  ...
  scale_x_continuous(limits = c(1, 41.5), breaks = c(1, seq(5, 41, 5), 41)) +
  ...
  labs(title = str_wrap(str_to_upper("número semanal de casos de dengue, 2013-2019"), width = 55),
       subtitle = "Casos confirmados hasta la semana epidemiológica 41",
  ...
  ggsave("03_graficas/numero_semanal_casos_confirmados_dengue_semana_41.png", width = 13.2, height = 10, dpi = 200)
...
g_2013 <- 
  ...
  scale_x_continuous(limits = c(1, 41.5), breaks = c(1, seq(5, 35, 5), 41)) +
...
# Definir título
titulo <- 
  ggdraw() + draw_label(str_to_upper("número semanal de casos confirmados de dengue\nen 2019 vs. cada año entre 2013 y 2018                   "), fontface = 'bold', size = 41, hjust = 0.5, fontfamily = "Trebuchet MS Bold", colour = "grey20")
...
plot_grid(titulo, espacio_vacio, grafica, caption, ncol = 1, rel_heights = c(0.13, 0.02, 1, 0.08)) +
  ggsave("03_graficas/barras_numero_semanal_casos_confirmados_dengue_semana_41.png", width = 15, height = 10, dpi = 200)





### Gráfica de LÍNEAS del número acumulado de casos confirmados de dengue hasta la semana epidemiológica 41 ----
...
bd %>% 
  ...
  theme(panel.grid = element_line(size = 0.3),
        legend.position = "none") +
  ggsave("03_graficas/numero_acumulado_casos_confirmados_dengue_semana_41.png", width = 13, height = 10, dpi = 200)




### Gráfica de BARRAS del número de casos confirmados de dengue hasta la semana epidemiológica 41 de cada año, 2013-2019 ----
...
bd %>% 
  ...
  labs(title = str_wrap(str_to_upper("número de casos confirmados de dengue hasta la semana epidemiológica 41, 2013-2019"), width = 55),
       x = "\n",
       y = NULL,
       caption = "@segasi / Fuente: SS, Boletín Epidemiológico y Panorama Epidemiológico de Dengue.") +
  tema +
  ...
  ggsave("03_graficas/numero_casos_confirmados_dengue_semana_41.png", width = 13, height = 10, dpi = 200)
